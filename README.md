...
**Recipe-App** is a Ruby-based project
...
- **Implement migrations, models and controllers in our Rails app**
- **Use devise for login and sign up authorization**
...
-  [WalkThrough Video](https://github.com/MarwanDev/recipe-app.git)
